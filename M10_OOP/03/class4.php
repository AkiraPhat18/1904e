...
class Student2 {
    public static $name = "dinh hai anh ";
    /**
...
/**
 * Tại sao dùng từ khóa static ?
 * khi mà muốn gọi 1 method hay 1 cái thuộc tính là class ở bên ngoài class đó
 * thì luôn phải khởi tạo 1 object đối tượng class đó
 */
